...
const TYPES = {
    ...
    NOTED: "Noted name", // "auct. non" = misapplied name
...
class JepsonEFlora {
    ...
    static #getStatusCode( jepsInfo ) {
        ...
        if ( this.#isSynonym( jepsInfo ) ) {
            return this.#getStatusCode( this.#nameInfo[ jepsInfo.under ] );
        }
    ...
    static #isSynonym( jepsInfo ) {
        switch ( jepsInfo.type ) {
            ...
            case TYPES.ORTH_VARIANT:
            case TYPES.SUPERFLUOUS:
            case TYPES.SYNONYM:
            case TYPES.SYN_INED:
            case TYPES.SYN_PART:
            case TYPES.SYN_PART_UN:
            case TYPES.UNABRIDGED:
                return true;
        }
        return false;
    }
