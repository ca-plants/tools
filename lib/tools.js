...
import { JepsonInterchange } from "./jepsoninterchange.js";
...
const TOOLS = {
    ...
    JEPSON_INT: "jepson-int",
    JEPSON_FAM: "jepson-families",
    RPI: "rpi",
    RPI_SCRAPE: "rpi-scrape",
};

const ALL_TOOLS = [ TOOLS.CALFLORA, TOOLS.INAT, TOOLS.JEPSON_EFLORA, TOOLS.JEPSON_INT, TOOLS.RPI, TOOLS.RPI_SCRAPE ];
...
const HELP = [
    ...
    },
    {
        ...
        content: [
            ...
            { tool: TOOLS.JEPSON_INT, desc: "Retrieve data from Jepson Interchange indexes and compare with local data." },
        ...
        for ( const tool of tools ) {
            switch ( tool ) {
                ...
                case TOOLS.JEPSON_EFLORA:
                    await JepsonEFlora.analyze( TOOLS_DATA_DIR, Taxa );
                    break;
                case TOOLS.JEPSON_INT:
                    await JepsonInterchange.analyze( TOOLS_DATA_DIR, Taxa );
                    break;
